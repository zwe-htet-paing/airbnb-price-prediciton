...
export MODEL_BUCKET_PROD="stg-mlflow-models-code-owners-airbnb-price-prediction"
export PREDICTIONS_STREAM_NAME="stg_airbnb_predictions-airbnb-price-prediction"
export LAMBDA_FUNCTION="stg_prediction_lambda-airbnb-price-prediction"

# Model artifacts bucket from the previous weeks (MLflow experiments)
export MODEL_BUCKET_DEV="mlflow-models-experiments"
